This is a minimal project on text classification, which can be run on the mila cluster. To go ahead and launch a cluster job running this experiment, go to the `cluster` folder and type `sbatch text.sbatch`.
